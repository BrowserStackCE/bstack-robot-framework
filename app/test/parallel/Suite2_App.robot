...
Appium Test on BrowserStack
    ...
    Open Application    ${REMOTE_URL}    app=%{BROWSERSTACK_APP_ID}    name=parallel_test    build=RobotFramework    platformName=Android    os_version=10.0    device=Google Pixel 4
	# id=org.wikipedia.alpha:id/search_container
