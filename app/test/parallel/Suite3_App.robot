...
Appium Test on BrowserStack
    ...
    Open Application    ${REMOTE_URL}    app=%{BROWSERSTACK_APP_ID}    name=parallel_test    build=RobotFramework    platformName=Android    os_version=9.0    device=Samsung Galaxy Tab S6
	# id=org.wikipedia.alpha:id/search_container
